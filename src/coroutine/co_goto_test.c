// outfile=$(mktemp); clang co_goto_test.c ../../lib/Unity/src/unity.c -o $outfile && $outfile
...
//    } gen_0_13_ctx_t;
//
// void gen_0_13(gen_0_13_ctx_t *ctx)
//
CO_DEFINE(gen_0_13, int value, int i)
{
    ...
    CO_BEGIN(34,38,41,44,47);   //协程开始
                                //33,37, ...: YIELD() 所在的行号; 若不正确, 则会编译失败 (e.g. use of undeclared label 'yield_32')
