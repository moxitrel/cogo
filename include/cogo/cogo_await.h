...
#undef COGO_IS_VALID
#define COGO_IS_VALID(AWAIT)      ((AWAIT) == (AWAIT) && (AWAIT) && COGO_AWAIT_IS_VALID(AWAIT))
#define COGO_AWAIT_IS_VALID(COGO) (COGO_PT_IS_VALID(COGO) && COGO_FUNC_OF(COGO) && ((COGO_TOP_OF(COGO) && COGO_PC(COGO) != COGO_PC_END) || (!COGO_TOP_OF(COGO) && COGO_PC(COGO) == COGO_PC_END)))
...
#define COGO_SCHED_IS_VALID(AWAIT_SCHED) ((AWAIT_SCHED) == (AWAIT_SCHED) && (AWAIT_SCHED) && COGO_AWAIT_SCHED_IS_VALID(AWAIT_SCHED))
#define COGO_AWAIT_SCHED_IS_VALID(SCHED) (COGO_SCHED_TOP_OF(SCHED) && COGO_IS_VALID(COGO_SCHED_TOP_OF(SCHED)) || !COGO_SCHED_TOP_OF(SCHED))
...
#define COGO_SCHED_RESUME(AWAIT_SCHED) cogo_await_sched_resume(AWAIT_SCHED)
